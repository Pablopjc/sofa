...
- **Light on your Mac.** Native Swift, ~11 MB on disk, 0% CPU when idle, universal binary for Apple Silicon and Intel.
...
**Requirements:** macOS 12 Monterey or newer, Apple Silicon or Intel. (The independent FaceTime call-volume slider needs macOS 14.2 or later — on older systems it's simply hidden.)
